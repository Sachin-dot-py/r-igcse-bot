...
import type { APIEmbedAuthor, APIEmbedField, APIEmbedFooter, APIEmbedImage, APIEmbedProvider, APIEmbedThumbnail, APIEmbedVideo, EmbedType } from "discord.js";
import {
	Repository,
	Schema,
	type Entity,
...
export class StickyMessageRepository extends Repository {
	...
	async set(
		id: string,
		stickyMessageData: ICachedStickyMessage
	) {
